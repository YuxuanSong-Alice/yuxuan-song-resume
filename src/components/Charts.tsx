...
const Charts: React.FC = () => {
  ...
  const chartTitles = {
    ...
    satisfaction: language === 'zh' ? '商家满意度提升' : 'Merchant Satisfaction Improvement',
  ...
  const buttonLabels = {
    ...
    satisfaction: language === 'zh' ? '商家满意度' : 'Satisfaction',
  ...
  return (
    <section className="py-16 border-b border-blue-100">
      ...
      <div className="chart-container">
        ...
        {activeChart === 'model' && (
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={modelOptimizationData}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(0, 102, 204, 0.1)" />
        ...
        {activeChart === 'satisfaction' && (
          <ResponsiveContainer width="100%" height={300}>
            <ComposedChart data={merchantSatisfactionData}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(0, 102, 204, 0.1)" />
              <XAxis dataKey="phase" />
              <YAxis yAxisId="left" />
              <YAxis yAxisId="right" orientation="right" />
